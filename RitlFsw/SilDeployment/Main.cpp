...
#include <RitlFsw/SilDeployment/Top/SilDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
void print_usage(const char* app) {
    (void)printf("Usage: ./%s [options]\n-a\thostname/IP address\n-p\tport_number\n-r\tenable RITL orch sender (connects to Python actuation server on port 50101)\n", app);
}
...
int main(int argc, char* argv[]) {
    ...
    RitlFsw::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
